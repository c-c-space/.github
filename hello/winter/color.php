...
<head>
  ...
  <title>日本の伝統的な冬の色</title>
  <meta property="og:title" content="日本の伝統的な冬の色">
  ...
  <meta property="og:url" content="https://creative-community.space/hello/winter/color.php">
  <meta content="https://creative-community.space/hello/winter/color.png" property="og:image">
  <meta content="https://creative-community.space/hello/winter/color.png" name="twitter:image:src">
</head>
...
<body>
  <dialog id="modal">
    <h1>
      <ruby>
        <b id="name">日本の伝統的な冬の色</b>
        <rp>(</rp>
        <rt id="yomi">WINTER | NOVEMBER 8 - FEBRUARY 3</rt>
        <rp>)</rp>
      </ruby>
    </h1>
    <code id="hex"></code>
