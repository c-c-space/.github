...
<body>
  ...
  <main id="hello" hidden>
    <section id="readme">
      <strong>The Year is divided into Four Seasons, <wbr>but traditionally the year was also divided up into 24 Sekki.</strong><br/>
      <strong><?php echo $sekkiDate;?> <?php echo $sekkiAbout;?></strong><br/>
      <br/>
